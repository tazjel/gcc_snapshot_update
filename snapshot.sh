...
lapack_build() 
{
    ...
    echo 'OPTS      = -O3 -march=native -funroll-loops -finline-limit=600 -fwhole-program -flto -fstack-arrays  -fno-protect-parens -fPIC' >> make.inc
    echo 'DRVOPTS   = $(OPTS)' >> make.inc
    echo 'NOOPT     = -O0 -ggdb -fPIC' >> make.inc
    echo 'LOADER    = gfortran' >> make.inc
    echo 'LOADOPTS  = -O3 -march=native -funroll-loops -finline-limit=600 -fwhole-program -flto -fstack-arrays  -fno-protect-parens -fPIC' >> make.inc
